...
grid_mins = np.array([-10., -4., 0.,      -3.6, -2., -np.pi/2, -np.pi/4])
grid_maxs = np.array([+10., +4., 2*np.pi, +3.6, +2., +np.pi/2, +np.pi/4])
...
x = np.array([4.0, -3.2, 5.6, -0.4, 0.8, -1., -np.pi/4.])
